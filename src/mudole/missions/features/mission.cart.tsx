...
const MissionCart = ({ image, title, isCompleted, score, totalScore, description, route}: MissionType) => {
            ...
            <div className="flex items-center gap-4">
                <div className="w-12 h-12 flex items-center justify-center relative">
                    <img
                        ...
                        loading="lazy"
                        onError={(e) => {
                            e.currentTarget.src = '/puzzle.svg' // تصویر پیش‌فرض در صورت خطا
                        }}
                    />
                </div>
                ...
                <div className="flex-1">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <MdKeyboardArrowDown
                                className={`text-gray-500 text-xl transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''
                                    }`}
                            />
                        </div>
                    </div>
