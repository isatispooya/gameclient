...
const Quiz: React.FC = () => {
  ...
  const getTimerColor = () => {
    return quizState.timeLeft <= 10 ? "bg-red-500" : "bg-green-500";
  };
    ...
    <div className="min-h-screen w-full text-[#0d3b66] p-8">
      <div className="w-full max-w-3xl mx-auto">
        ...
        <div className="w-full mt-4 h-4 bg-gray-200 rounded-full mb-4 border-2 border-[#0d3b66]/50">
          <div
            ...
            style={{
              ...
              boxShadow: quizState.timeLeft <= 10 
        ...
        {quizState.showResult && (
          <div
            className={`
              w-full p-4 mb-4 text-center rounded-xl
        ...
        <div className="w-full grid grid-cols-2 gap-4">
          {currentQuestion.options.map((option, index) => (
            <button
              ...
              className={`
                aspect-square p-4 text-base text-center flex items-center justify-center
