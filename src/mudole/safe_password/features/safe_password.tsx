      ...
      <div className="flex flex-col items-center justify-center p-6 ">
        <div className="w-full max-w-md p-6 rounded-xl bg-white shadow-2xl border-4 border-blue-200">
          ...
          <p className="text-gray-600 text-center mb-6">
            در مسیر حل این پرونده به{" "}
            <span className="font-bold">گاوصندوقی</span> برخوردیم که برخی از
            شواهد دیگر در آن قرار دارد،لازم است رمز را از{" "}
            <span className="font-bold">کارآگاهان</span> ما که در انتهای سالن
            قرار دارند بگیرید تا سرنخ هارا پیدا کنید.
          </p>
